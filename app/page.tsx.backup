            ...
            <div className="grid md:grid-cols-3 gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <p className="text-lg font-semibold text-foreground transition-colors duration-700 hover:text-primary">{stat.label}</p>
                </ScrollAnimatedSection>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <h3 className="text-primary text-xl font-bold mb-4 transition-colors duration-700">Pendaftaran Dibuka</h3>
                <p className="text-3xl font-bold text-accent mb-2 transition-transform duration-700 hover:scale-110">1 November 2025</p>
                <p className="text-muted-foreground font-medium transition-colors duration-700">Pukul 08:00 WIB</p>
              </ScrollAnimatedSection>
              <ScrollAnimatedSection 
                animationType="slide-up" 
                delay={300}
                className="border-2 border-primary/20 hover:border-primary/50 transition-all duration-700 rounded-lg p-6 bg-card transform hover:-translate-y-2 hover:shadow-lg"
              >
                <h3 className="text-primary text-xl font-bold mb-4 transition-colors duration-700">Batas Pendaftaran</h3>
                <p className="text-3xl font-bold text-accent mb-2 transition-transform duration-700 hover:scale-110">28 Februari 2025</p>
                <p className="text-muted-foreground font-medium transition-colors duration-700">Jangan sampai terlewatkan!</p>
              </ScrollAnimatedSection>
              <ScrollAnimatedSection 
                animationType="slide-up" 
                delay={400}
                className="border-2 border-primary/20 hover:border-primary/50 transition-all duration-700 rounded-lg p-6 bg-card transform hover:-translate-y-2 hover:shadow-lg"
              >
                <h3 className="text-primary text-xl font-bold mb-4 transition-colors duration-700">Pengumuman Hasil</h3>
                <p className="text-3xl font-bold text-accent mb-2 transition-transform duration-700 hover:scale-110">20 Maret 2025</p>
                <p className="text-muted-foreground font-medium transition-colors duration-700">Harapkan kabar gembira!</p>
              </ScrollAnimatedSection>
            </div>
          </div>
        </section>
...
{/* bagian ektrakurikuler disini */}
        ...
        <section id="info" className="py-16 md:py-20 bg-muted/50">
          <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollAnimatedSection animationType="slide-up" className="animate-slide-up">
                ...
                <div className="space-y-6">
                  ...
                  <div className="transition-transform duration-700 hover:translate-x-2">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start gap-3 transition-transform duration-700 hover:translate-x-1">
                        <span className="text-accent font-bold text-lg flex-shrink-0">✓</span>
                        <span className="text-muted-foreground font-medium transition-colors duration-700">Guru bersertifikat dan berpengalaman</span>
                      </li>
                      <li className="flex items-start gap-3 transition-transform duration-700 hover:translate-x-1">
                        <span className="text-accent font-bold text-lg flex-shrink-0">✓</span>
                        <span className="text-muted-foreground font-medium transition-colors duration-700">Fasilitas lengkap dan aman</span>
                      </li>
                      <li className="flex items-start gap-3 transition-transform duration-700 hover:translate-x-1">
                        <span className="text-accent font-bold text-lg flex-shrink-0">✓</span>
                        <span className="text-muted-foreground font-medium transition-colors duration-700">
                ...
                <div className="space-y-6">
                  ...
                  <div className="transition-transform duration-700 hover:translate-x-1">
                    ...
                    <div className="text-muted-foreground font-medium space-y-1">
                      <p><a href="https://wa.me/6287872582297" className="hover:underline">📞 0878-7258-2297 (Bunda Tri)</a></p>
                      <p><a href="https://wa.me/6281541500923" className="hover:underline">📞 0815-4150-0923 (Bunda Risma)</a></p>
                      <p><a href="https://wa.me/6285763680886" className="hover:underline">📞 0857-6368-0886 (Bunda Siti)</a></p>
                      <p><a href="https://wa.me/6285839850938" className="hover:underline">📞 0858-3985-0938 (Bunda Lita)</a></p>
                    </div>
                  </div>
                  <div className="transition-transform duration-700 hover:translate-x-1">
                    <p className="font-bold text-foreground mb-1">Email</p>
                    <a href="mailto:info@tkaisyiyah.ac.id" className="text-accent font-bold hover:underline transition-colors duration-700">
      ...
      <ScrollAnimatedSection animationType="fade-in">
        <section className="py-16 md:py-20 bg-gradient-to-r from-primary/5 to-accent/5">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold mb-12 text-center text-primary">Apa Kata Orang Tua</h2>
            <ScrollAnimatedSection animationType="slide-up" delay={100} className="relative">
      ...
      <ScrollAnimatedSection animationType="fade-in">
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold mb-12 text-center text-primary">Pertanyaan Umum</h2>

          <ScrollAnimatedSection animationType="slide-up" delay={100} className="space-y-12">
                  ...
                  {section.questions.map((faq, idx) => (
                    ...
                    >
                      <summary className="cursor-pointer bg-muted/50 hover:bg-muted px-6 py-4 font-bold text-primary flex justify-between items-center transition-colors duration-700">
                        <span>{faq.q}</span>
                        <span className="text-accent text-xl transition-transform duration-700">+</span>
                      </summary>
          ...
          <ScrollAnimatedSection 
            animationType="slide-up" 
            delay={200}
            className="mt-12 p-6 bg-primary/10 rounded-lg border-2 border-primary/30 transition-all duration-700 hover:shadow-lg"
          >
            <p className="text-center text-muted-foreground font-medium">
              Informasi Lebih Lanjut:
              <br />
              <a href="https://wa.me/6287872582297" className="hover:underline">📞 0878-7258-2297 (Bunda Tri)</a>
              <br />
              <a href="https://wa.me/6281541500923" className="hover:underline">📞 0815-4150-0923 (Bunda Risma)</a>
              <br />
              <a href="https://wa.me/6285763680886" className="hover:underline">📞 0857-6368-0886 (Bunda Siti)</a>
              <br />
              <a href="https://wa.me/6285839850938" className="hover:underline">📞 0858-3985-0938 (Bunda Lita)</a>
            </p>
          </ScrollAnimatedSection>
        </div>
      </section>
      ...
      <ScrollAnimatedSection animationType="fade-in">
        <section className="py-16 md:py-20 bg-muted/50">
          <div className="container mx-auto px-4">
            ...
            <ScrollAnimatedSection animationType="slide-up" delay={100} className="grid md:grid-cols-2 gap-8 items-center">
              <div className="transition-transform duration-700 hover:translate-x-2">
      ...
      <ScrollAnimatedSection animationType="fade-in">
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <ScrollAnimatedSection animationType="slide-up" delay={100} className="flex justify-center gap-6 flex-wrap">
              {socialMedia.map((media, index) => (
                ...
                >
                  <div className="text-primary group-hover:text-accent transition-colors duration-700 transform group-hover:scale-110">{media.icon}</div>
      ...
      <ScrollAnimatedSection animationType="fade-in">
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-4xl font-bold mb-12 text-center text-primary">Hubungi Kami</h2>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <ScrollAnimatedSection animationType="slide-up" delay={100} className="">
              ...
              <ScrollAnimatedSection animationType="slide-up" delay={200} className="">
                <ContactForm />
              </ScrollAnimatedSection>
            </div>
          </div>
