...
export default function ProgramPendidikan() {
  ...
  const kelompokUsiaRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    ...
    if (kelompokUsiaRef.current) {
      registerElement('kelompok-usia', kelompokUsiaRef.current);
    }
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-12 md:py-16 flex-1">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-primary text-center">Program Unggulan</h2>
            <p className="text-muted-foreground text-center mb-10 max-w-3xl mx-auto">
              Kami menawarkan program unggulan yang dirancang untuk mendukung tumbuh kembang anak secara optimal.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">1. Model pembelajaran berkesadaran, bermakna & menggembirakan</h3>
                <p className="text-muted-foreground">Pembelajaran yang memberikan pengalaman bermakna bagi anak melalui pendekatan yang menyenangkan dan penuh kesadaran.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">2. Kelas Inspirasi / Kelas Orang Tua</h3>
                <p className="text-muted-foreground">Kelas khusus untuk meningkatkan kapasitas orang tua dalam mendukung perkembangan anak melalui pendidikan karakter.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">3. Outing Class</h3>
                <p className="text-muted-foreground">Kegiatan pembelajaran di luar kelas untuk memberikan pengalaman langsung kepada anak tentang dunia nyata.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">4. Mengedepankan nilai Islami</h3>
                <p className="text-muted-foreground">Pembentuan karakter berdasarkan nilai-nilai Islami yang diintegrasikan dalam setiap kegiatan pembelajaran.</p>
              </div>
            </div>
          </div>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-primary text-center">Ekstrakurikuler</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">1. Drumband</h3>
                <p className="text-muted-foreground">Kegiatan ekstrakurikuler drumband yang mengembangkan bakat musik, kedisiplinan, dan kerja sama tim anak.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">2. Mewarnai</h3>
                <p className="text-muted-foreground">Kegiatan kreatif yang meningkatkan konsentrasi, ketelitian, dan daya imajinasi anak melalui seni mewarnai.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">3. Menari</h3>
                <p className="text-muted-foreground">Ekstrakurikuler tari yang mengembangkan koordinasi gerak, kepercayaan diri, dan apresiasi seni anak.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50">
                <h3 className="text-xl font-bold text-primary mb-3">4. Hizbul Wathan</h3>
                <p className="text-muted-foreground">Kegiatan keorganisasian keagamaan yang membentuk karakter dan kepribadian anak berdasarkan nilai-nilai keislaman.</p>
              </div>
              <div className="bg-muted p-6 rounded-lg border border-primary/20 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/50 md:col-span-2">
                <h3 className="text-xl font-bold text-primary mb-3">5. TPQ (Taman Pendidikan Al-Qur'an)</h3>
                <p className="text-muted-foreground">Program pendidikan Al-Qur'an untuk anak-anak yang bertujuan membentuk budi pekerti luhur dan memperkenalkan nilai-nilai agama Islam.</p>
              </div>
            </div>
          </div>
          ...
          <div 
            ref={kelompokUsiaRef}
            className={`my-12 transition-all duration-700 ease-out transform-gpu ${
              isVisible['kelompok-usia'] !== undefined 
                ? (isVisible['kelompok-usia'] 
                    ? 'opacity-100 translate-y-0' 
                    : 'opacity-0 translate-y-10')
                : 'opacity-100 translate-y-0' // Default to visible if not yet observed
            }`}
          >
            <h2 className="text-3xl font-bold my-6 text-primary text-center">Persyaratan & Kelompok Usia</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="border-l-4 border-l-primary">
                <CardHeader>
                  <CardTitle className="text-primary">Persyaratan Usia</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-l-4 border-l-accent">
                <CardHeader>
                  <CardTitle className="text-primary">Perincian Kelompok</CardTitle>
                </CardHeader>
                <CardContent>
                  {ageGroups.map((group, index) => (
                    <div key={index} className={`${index !== 0 ? 'mt-4' : ''}`}>
                      ...
                      <p className="text-muted-foreground text-sm">{group.focus}</p>
                    </div>
                  ))}
                </CardContent>
              </Card>
