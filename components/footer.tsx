export default function Footer() {
  return (
    <footer className="bg-primary text-primary-foreground dark:bg-primary dark:text-foreground mt-auto">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8 dark:text-slate-950">
          <div>
            <h3 className="font-bold text-lg mb-4">TK Aisyiyah Iringmulyo</h3>
            <p className="text-primary-foreground/80 mb-2">
              Lembaga pendidikan anak usia dini yang berkomitmen pada
              pengembangan karakter dan akademik anak.
            </p>
            <p className="text-primary-foreground/80">
              Jl. Abri No. 26, Metro, Lampung
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-primary-foreground/20 pt-8 text-center dark:text-slate-950">
