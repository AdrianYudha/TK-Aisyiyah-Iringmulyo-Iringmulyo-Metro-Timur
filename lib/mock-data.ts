// mock-data.ts - File untuk menyimpan data mock secara global

// Gunakan WeakMap untuk menyimpan state dalam pengembangan, tapi sebenarnya dalam produksi
// Anda akan menggunakan database

// Untuk mengatasi HMR di lingkungan development, kita simpan data di global object
declare global {
  var mockRegistrations: any[];
}

// Inisialisasi data mock hanya jika belum ada
if (!global.mockRegistrations) {
  global.mockRegistrations = [
    {
      id: "1",
      user_id: "user_1",
...
export const mockRegistrations = global.mockRegistrations;
